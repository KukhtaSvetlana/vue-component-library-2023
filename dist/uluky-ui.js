...
const nv = be({
  ...
  setup(e, { expose: t, emit: n }) {
    ...
    const he = () => {
      ...
      const I = P.value, N = o.formatter ? o.formatter(re.value) : re.value;
...
const lm = /* @__PURE__ */ ve(F0, [["__scopeId", "data-v-3ca34c15"]]), H0 = { class: "flx flx-align-center" }, N0 = ["textContent"], z0 = /* @__PURE__ */ M({
  ...
  setup(e) {
    return (t, n) => (_(), O("div", H0, [
      ...
      oe(c(ro), { content: "test" }),
      oe(qo, { class: "ml-10" })
    ]));
  }
});
const im = /* @__PURE__ */ ve(z0, [["__scopeId", "data-v-f33ba75c"]]), V0 = ["textContent"], um = /* @__PURE__ */ M({
  __name: "UTag",
  props: {
    color: {},
    label: {}
