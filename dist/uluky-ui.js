import { openBlock as l, createElementBlock as d, createElementVNode as i, warn as Ee, watch as Ze, unref as p, inject as H, ref as K, computed as k, getCurrentInstance as be, defineComponent as u, mergeProps as ne, renderSlot as F, useSlots as ye, Text as Ge, createBlock as j, resolveDynamicComponent as U, withCtx as R, Fragment as De, normalizeClass as a, createCommentVNode as P, provide as Ue, reactive as qe, toRef as ue, createSlots as Ke, createTextVNode as $e, toDisplayString as Se, createStaticVNode as se, pushScopeId as E, popScopeId as Z } from "vue";
process.env.NODE_ENV !== "production" && Object.freeze({});
process.env.NODE_ENV !== "production" && Object.freeze([]);
const We = () => {
}, Je = Object.prototype.hasOwnProperty, he = (e, t) => Je.call(e, t), ie = (e) => typeof e == "string", Ce = (e) => e !== null && typeof e == "object";
function Xe(e) {
...
const xe = "__epPropKey", ae = (e) => e, ut = (e) => Ce(e) && !!e[xe], Ie = (e, t) => {
  ...
  if (e.install = (o) => {
    ...
    for (const [o, r] of Object.entries(t))
      e[o] = r;
  return e;
}, ht = (e) => (e.install = We, e), pt = ["", "default", "small", "large"], ft = ({ from: e, replacement: t, scope: o, version: r, ref: n, type: s = "API" }, c) => {
  Ze(() => p(c), (f) => {
...
const ge = je(Mt), ce = Symbol("formContextKey"), Ve = Symbol("formItemContextKey"), xt = (e, t = {}) => {
  const o = K(void 0), r = t.prop ? o : He("size"), n = t.global ? o : mt(), s = t.form ? { size: void 0 } : H(ce, void 0), c = t.formItem ? { size: void 0 } : H(Ve, void 0);
  ...
  const o = H(Ae, void 0), r = yt("button"), { form: n } = It(), s = xt(k(() => o == null ? void 0 : o.size)), c = Le(), f = K(), g = ye(), b = k(() => e.type || (o == null ? void 0 : o.type) || ""), $ = k(() => {
    var I, h, _;
...
function Tt(e, t, o) {
  ...
  var r = Math.floor(e), n = e - r, s = o * (1 - t), c = o * (1 - n * t), f = o * (1 - (1 - n) * t), g = r % 6, b = [o, c, s, s, f, o][g], $ = [f, o, o, c, s, s][g], S = [s, s, f, o, o, c][g];
...
var Et = "[-\\+]?\\d+%?", Zt = "[-\\+]?\\d*\\.\\d+%?", L = "(?:".concat(Zt, ")|(?:").concat(Et, ")"), Q = "[\\s|\\(]+(".concat(L, ")[,|\\s]+(").concat(L, ")[,|\\s]+(").concat(L, ")\\s*\\)?"), ee = "[\\s|\\(]+(".concat(L, ")[,|\\s]+(").concat(L, ")[,|\\s]+(").concat(L, ")[,|\\s]+(").concat(L, ")\\s*\\)?"), x = {
...
var Dt = (
  ...
  function() {
    ...
    return e.prototype.isDark = function() {
      ...
      var t = ke(this.r, this.g, this.b), o = Math.round(t.h * 360), r = Math.round(t.s * 100), n = Math.round(t.v * 100);
      ...
      var t = ve(this.r, this.g, this.b), o = Math.round(t.h * 360), r = Math.round(t.s * 100), n = Math.round(t.l * 100);
...
const qt = u({
  ...
  setup(e, { expose: t, emit: o }) {
    const r = e, n = Ut(r), s = W("button"), { _ref: c, _size: f, _type: g, _disabled: b, _props: $, shouldAddSpace: S, handleClick: T } = Bt(r, o);
    return t({
      ref: c,
      size: f,
      type: g,
...
var Fe = /* @__PURE__ */ ((e) => (e.left = "left", e.right = "right", e.up = "up", e.down = "down", e))(Fe || {}), z = /* @__PURE__ */ ((e) => (e.s24 = "s24", e.s32 = "s32", e))(z || {}), Re = /* @__PURE__ */ ((e) => (e.s_32_27 = "s_32_27", e.s_42_36 = "s_42_36", e))(Re || {}), eo = /* @__PURE__ */ ((e) => (e.Back = "Back", e.Forward = "Forward", e))(eo || {}), w = /* @__PURE__ */ ((e) => (e.primary = "primary", e.secondary = "secondary", e.allusion = "allusion", e.contrast = "contrast", e.warning = "warning", e.success = "success", e.hint = "hint", e.search = "search", e))(w || {}), q = /* @__PURE__ */ ((e) => (e.s10 = "s10", e.s6 = "s6", e))(q || {});
const to = ["width", "height"], oo = /* @__PURE__ */ se('<path fill-rule="evenodd" clip-rule="evenodd" d="M17.1436 17.023C16.3059 17.9725 15.08 18.5715 13.7142 18.5715C11.1895 18.5715 9.14282 16.5248 9.14282 14V0.285767L4.5714 4.13539L-3.05176e-05 0.285767V14C-3.05176e-05 21.5742 6.14006 27.7143 13.7142 27.7143C16.7015 27.7143 19.4658 26.7592 21.7182 25.1377C19.4247 23.0194 17.7869 20.2015 17.1436 17.023ZM27.4285 14V4.13539H27.4285V14L27.4285 14.0156L27.4285 14Z" fill="url(#paint0_angular_1275_2312)"></path><path fill-rule="evenodd" clip-rule="evenodd" d="M18.2857 14V4.13539L22.8571 0.285767L27.4286 4.13539V14C27.4286 16.5248 29.4753 18.5715 32 18.5715V27.7143C24.4258 27.7143 18.2857 21.5742 18.2857 14Z" fill="url(#paint1_linear_1275_2312)"></path><defs><radialGradient id="paint0_angular_1275_2312" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(13.7142 14) rotate(-90.2832) scale(18.4699 19.455)"><stop stop-color="#6CA2F2"></stop><stop offset="1" stop-color="#2CBC9A"></stop></radialGradient><linearGradient id="paint1_linear_1275_2312" x1="25.1428" y1="0.285767" x2="25.1428" y2="27.7143" gradientUnits="userSpaceOnUse"><stop stop-color="#3499B9"></stop><stop offset="1" stop-color="#3451B9"></stop></linearGradient></defs>', 3), ro = [
  oo
], Rr = /* @__PURE__ */ u({
  __name: "BrandLogo",
  props: {
...
const M = (e, t) => {
  ...
  for (const [r, n] of t)
    o[r] = n;
  return o;
}, no = {}, Pe = (e) => (E("data-v-b7104ab3"), e = e(), Z(), e), so = {
  width: "97",
  height: "97",
  viewBox: "0 0 97 97",
  fill: "none",
...
const Wr = /* @__PURE__ */ M(bo, [["__scopeId", "data-v-1941253c"]]), yo = {
  width: "24",
  height: "24",
  viewBox: "0 0 24 24",
  fill: "none",
...
const Qr = /* @__PURE__ */ M(Vo, [["__scopeId", "data-v-c9b828dc"]]), Lo = {
  width: "24",
  height: "24",
  viewBox: "0 0 24 24",
  fill: "none",
...
const rn = /* @__PURE__ */ M(To, [["__scopeId", "data-v-34ecf1b8"]]), Fo = {
  width: "24",
  height: "24",
  viewBox: "0 0 24 24",
  fill: "none",
...
}), Eo = (e) => (E("data-v-7c9a8f75"), e = e(), Z(), e), Zo = {
  width: "24",
  height: "24",
  viewBox: "0 0 24 24",
  fill: "none",
...
const ln = /* @__PURE__ */ M(Do, [["__scopeId", "data-v-7c9a8f75"]]), Uo = {
  width: "24",
  height: "24",
  viewBox: "0 0 24 24",
  fill: "none",
...
const gn = /* @__PURE__ */ M(er, [["__scopeId", "data-v-24b2944f"]]), tr = { class: "size-24" }, or = {
  width: "24",
  height: "24",
  viewBox: "0 0 24 24",
  fill: "none",
...
const vn = /* @__PURE__ */ M(rr, [["__scopeId", "data-v-ff8726ff"]]), nr = {
  width: "24",
  height: "24",
  viewBox: "0 0 24 24",
  fill: "none",
...
const kn = /* @__PURE__ */ M(sr, [["__scopeId", "data-v-f6d6d045"]]), ir = {
  key: 0,
  width: "24",
  height: "24",
  viewBox: "0 0 24 24",
...
const mn = /* @__PURE__ */ M(dr, [["__scopeId", "data-v-65c8068c"]]);
var O = /* @__PURE__ */ ((e) => (e.send = "send", e.receive = "receive", e))(O || {});
const de = (e) => (E("data-v-2a486ace"), e = e(), Z(), e), ur = ["width", "height"], hr = /* @__PURE__ */ de(() => /* @__PURE__ */ i("path", {
...
const Oe = /* @__PURE__ */ M(gr, [["__scopeId", "data-v-2a486ace"]]), bn = /* @__PURE__ */ u({
...
const Sn = /* @__PURE__ */ M(Ir, [["__scopeId", "data-v-1899fca1"]]), X = (e) => (E("data-v-2261154c"), e = e(), Z(), e), Br = {
  width: "96",
  height: "96",
  viewBox: "0 0 96 96",
  fill: "none",
...
const Cn = /* @__PURE__ */ M(Nr, [["__scopeId", "data-v-2261154c"]]);
export {
  re as EButtonDesign,
  Te as EButtonSize,
